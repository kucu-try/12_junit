...
public class TestAnnotationTests {
 /*
 *  1. junit platform
 * - jvm에서 테스트 프레임 워크를 실행하기 위한 테스트 엔진을 제공한다
 * 2. junit jupiter
 *  - junit5 에서 테스트를 작성하고 실행하기 위한 엔진을 제공한다
 * 3. junuit vintage
 * -junit3,4를 기반으로 돌아가는 테스트 엔진을 제공해준다
 * */

    /*
    *  테스트 클래스는 적어도 한 개 이상의 @Test 어노테이션이 달린 메소드를 가진 클래스이다
    * 테스트 클래스는 abstract이면 안되고, 한 개의 생성자를 가지고 있어야한다
    ...
    * */
    ...
    public void 테스트_메소드2(){
        /*
        * 클래스 레벨 @DisplayNameGenerator 를 붙이게 되면 언더바를 공백으로 처리하여 테스트 이름을 부여해 준다
